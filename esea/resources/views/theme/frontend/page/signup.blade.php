                                  ...
                                  <div class="form-group">
                                        <div class="pretty p-default p-curve p-thick checkbox-field-3 w-checkbox">
                                            ...
                                            <div class="state p-danger-o">  
                                                <label>{{trans('front.homepage.signup.iagree')}}&#x27;s <a href="#" target="_blank" class="link-15">{{trans('front.homepage.signup.term')}}</a> {{trans('front.homepage.signup.and')}} <a href="#" target="_blank" class="link-15">{{trans('front.homepage.signup.policy')}}</a>.</label>
                                            </div>
                                        </div>
                                    <div class="help-block with-errors"></div>
                                  </div>
