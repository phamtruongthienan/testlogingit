<div id="Introdution" class="section-18">
    <div class="main-container w-container">
        ...
        <div class="div-block-1259">
            ...
            @endif
            <div class="row">
                <div class="col-2"><img src="{{$logo_school}}"></div>
                <div class="col-6">
                    <h1 class="heading-22">
                    ...
                    <div class="div-block-1151" style="margin-top:10px" id="MapD">
                        <a class="address-link-2" target="_blank" href="https://www.google.com/maps/search/{{ urlencode($school_detail[0]->mSchooltranslations[0]->name.', '.$school_detail[0]->mSchooltranslations[0]->address) }}" class="link-7" style="font-size:13px">
                            <i class="fas fa-map-marked-alt"></i> {{$school_detail[0]->mSchooltranslations[0]->address}} - <span style="text-decoration: underline;font-weight:700">{{trans('front.homepage.intro.viewmap')}}</span>
                        </a>
                    </div>
                ...
                <div class="col-4" style="text-align: center;margin-top: 20px;">
                        <div style="margin-bottom: 20px;">
                                ...
                                @endphp
                            <span class="badge badge-primary" style="margin-right:10px;font-size:15px">{{trans('front.homepage.intro.rate')}}: {{round($count/$index)}}/10</span>
                        ...
                        <ul class="social-network social-circle">
                                <li>
                                    <a data-toggle="tooltip" data-placement="bottom" data-original-title="Liên hệ" href="tel:{{$school_detail[0]->mSchooltranslations[0]->phone}}" class="icoRss" target="_blank">
                                        <i class="fas fa-phone"></i>
                                    </a>
                                </li>
                                <li>
                                    <a  data-toggle="tooltip" data-placement="bottom" data-original-title="Fanpage" href="{{$school_detail[0]->facebook_page}}" class="icoFacebook" target="_blank">
