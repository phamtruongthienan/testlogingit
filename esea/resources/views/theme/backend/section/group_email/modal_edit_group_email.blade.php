<!-- Edit modal employee -->
<div class="modal fade" id="modal-groupreceiver-edit" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="editGroupReceiverForm" role="form" data-toggle="validator">
                                ...
                                <div id="selectEmail" class="hidden">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control select2 select-email" id="edit_email"
                                                    name="edit_email[]"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="editGroupReceiverBtn"
