<!-- Add modal localization -->
<div class="modal fade" id="modal-localization-add" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="addLocalizationForm" role="form" data-toggle="validator">
                                <div class="form-group">
                                    <label for="inputAddKey"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="addLocalizationBtn"
