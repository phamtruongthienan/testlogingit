<!-- Add modal customer -->
<div class="modal fade" id="modal-attribute-add" data-backdrop="static">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_vn_edit">
                            <form class="form-horizontal" id="addAttributeForm" role="form" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2 select-attribute-add" id="add_type_attribute"
                                                name="type_attribute"
                                                style="width: 100%;">
                                ...
                                <div id="inputAttribute">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="inputAddUnit" value=""
