 ...
 * @package App\Models
 */
class MSchoolClassTranslation extends Eloquent
{
    use Searchable;
    public $asYouType = true;

    use \Illuminate\Database\Eloquent\SoftDeletes;
    protected $table = 'm_school_class_translation';
    ...
    {
        return $this->belongsTo(\App\Models\MSchoolClass::class, 'translation_id');
    }
}
