        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <i class="fas fa-user-graduate" id="ttlModal"></i>
                </h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="editEmployeeForm" role="form" data-toggle="validator">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" name="inputEditUserName" id="inputEditUserName" value="" required data-error="Email không được để trống">
