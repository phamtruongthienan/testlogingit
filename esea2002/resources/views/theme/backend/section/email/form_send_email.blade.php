<div class="box box-primary" id="send-mail-form">
        ...
        <form class="form-horizontal" id="sendForm" role="form" data-toggle="validator">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control select2" style="width: 100%;" id="inputAddType" name="inputAddType">
                        <option>Chọn nhóm người nhận</option>
                            @foreach($groupMail as $key => $val)
            ...
            <div class="box-footer">
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-primary send-mail" id='send-mail'>Gửi</button>
