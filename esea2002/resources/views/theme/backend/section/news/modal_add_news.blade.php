<!-- Add modal customer -->
<div class="modal fade" id="modal-news-add" data-backdrop="static">
                            ...
                            <form class="form-horizontal" id="addNewsForm" role="form" data-toggle="validator">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="col-sm-6 no-padding-left">
                                            <select class="form-control select2" style="width: 100%;" id="inputAddLayout"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 padding-top-7">
                                        <input type="checkbox" name="addStatus" class="minimal">
                                    </div>
                                </div>
                            </form>
                        </div>
