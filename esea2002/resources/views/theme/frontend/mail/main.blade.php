	        ...
	        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 0 auto;">
	            ...
	            <tr>
	                <td style="padding: 20px 0; text-align: center">
	                    <img src="{{asset('assets/frontend/images/logo.svg')}}" width="200" height="50" alt="Esearch" border="0" style="height: auto; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555;">
	                </td>
	            </tr>
		        <!-- Email Header : END -->
                ...
                <tr>
                    <td style="background-color: #ffffff;">
                        <img src="{{asset('assets/frontend/images/DSCF1393.JPG')}}" width="680" height="" alt="Esearch" border="0" style="width: 100%; max-width: 680px; height: auto; background: #dddddd; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto;" class="fluid g-img">
                    </td>
                </tr>
