<div class="section-21">
    <div class="container-16 w-container" id="Review">
        <div class="div-block-1140">
                    ...
                    <form id="form-review" role="form" data-toggle="validator" novalidate="true">
                        <div class="row div-block-1273">
                            <div class="col-lg-5 col-xl-5 col-md-5 col-sm-12 col-12 form-group">
                                <div class="text-block-64 rating-star" style="font-size:20px;text-align: center;">{{trans('front.homepage.intro.howfeelschool')}}</div>
                            ...
                            <div class="col-lg-7 col-xl-7 col-md-7 col-sm-12 col-12">
                                    <div class="widget-area no-padding blank">
                                        <div class="text-block-64 rating-star" style="font-size:20px;text-align: center;">{{trans('front.homepage.intro.enterreview')}}</div>
                                        <div class="status-upload form-group">
                                                <textarea name="comment" placeholder="{{trans('front.homepage.intro.leavereview')}}" style=" resize: none;" required></textarea>
                                                ...
                                                <a class="w-inline-block btn-review" style="margin-top:2px;float:right">
                                                    <div class="button-review-1">{{trans('front.homepage.intro.review')}}</div> 
                                                </a>
                                            </div>
            ...
            <div class="rating-panel row div-block-1273">
                    <div class="div-block-1291" id="review_pagination" style="width: 100%;">
                            <div class="text-block-64 rating-star" style="font-size:20px;text-align: center;">{{$school_detail[0]->review}} {{trans('front.homepage.intro.reviewfromcustommer')}}</div>
                                ...
                                @endif
                                        ...
                                        <li>
                                            <div class="comment-main-level">
                                                <div class="comment-avatar"><img src="{{$logo_avatar}}" alt="Esearch"></div>
                                                <div class="comment-box">
                                                    <div class="comment-head">
                                                        <div  style="float:left;">
                                                            <h6>{{$val->mCustomer->name}}</h6>
                                                            <small>{{trans('front.homepage.intro.memberfromyear')}} {{ \Carbon\Carbon::parse($val->mCustomer->created_at)->format('Y')}}</small>
                                                        </div>
                                                        <div  style="float:right;">
                                                            <small>{{trans('front.homepage.intro.commented')}} {{ \Carbon\Carbon::parse($val->created_at)->format($config_language[0]->date_format)}}</small>
