    ...
    <div class="container-15 w-container">
        <div class="div-block-1270">
            <div class="div-block-1278">
                ...
                <div id="price" class="div-block-1269 item-flex-start">
                    @php
                    ...
                    @if(!empty(Auth::user()))
                    <a target="_blank" rel="noreferrer" href="{{$link_pdf}}" class="button-11 w-button">{{trans('front.homepage.intro.pdffee')}}<br></a>
                    @else
                    <a href="{{asset('login')}}?ref={{request()->path()}}" class="button-11 w-button"> {{trans('front.homepage.intro.price')}}<br></a>
                    @endif
                </div>
                @endif
