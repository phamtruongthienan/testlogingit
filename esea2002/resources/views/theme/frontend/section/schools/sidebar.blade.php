<div class="div-block-2-column-1-copy">
    ...
    <div class="sidebar-wrapper">
      <div class="form-block-5-copy w-form">
          <label for="name" class="field-label-3">{{trans('front.homepage.search.keyword')}} <a href="#" class="btn_delete_search" id="delete_keyword" style="float:right;display:none">Xóa</a></label>
          ...
          <label for="name" class="field-label-3">{{trans('front.homepage.search.location')}} <a href="#" class="btn_delete_search" id="delete_location" style="float:right;display:none">Xóa</a></label>
          ...
          <label for="email-3" class="field-label-3">{{trans('front.homepage.search.level')}} <a href="#" class="btn_delete_search" id="delete_level" style="float:right;display:none">Xóa</a></label>
          <select id="level" name="level" class="search-sticky txt-search advanced_search search_sidebar"><select>
          <label for="email-3" class="field-label-3">{{trans('front.homepage.search.type')}} <a href="#" class="btn_delete_search" id="delete_type" style="float:right;display:none">Xóa</a></label>
          <select id="type" name="type" class="search-sticky txt-search advanced_search search_sidebar"><select>
            <label for="email-3" class="field-label-3">{{trans('front.homepage.search.languages')}} <a href="#" class="btn_delete_search" id="delete_language" style="float:right;display:none">Xóa</a></label>
    ...
    <div>
      <div class="div-block-65">
        <div class="w-form">
            <label for="name" class="field-label-4">{{trans('front.homepage.search.evaluate')}}: <a href="#" class="btn_delete_search" id="delete_rating" style="float:right;display:none">Xóa</a></label>
            @for($i =1; $i <= 5; $i++)
           ...
           <label for="name" class="field-label-4">{{trans('front.homepage.search.price')}}: <a href="#" class="btn_delete_search" id="delete_price" style="float:right;display:none">Xóa</a></label>
           <div class="pretty p-default p-curve p-thick checkbox-field-3 w-checkbox">
            ...
            <label for="name" class="field-label-4">{{trans('front.homepage.search.utilities')}}: <a href="#" class="btn_delete_search" id="delete_service" style="float:right;display:none">Xóa</a></label>
