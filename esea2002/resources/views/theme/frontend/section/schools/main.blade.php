    ...
    @foreach($ads as $ka => $va)
        ...
        @if($va->position == 1 && $va->type==3)
            ...
            <div class="advertising" style=" background-image: url({{$ads_image}});">
                <a href="{{ $ads_link }}" target="_blank" rel="noreferrer" class="link-block-promotion w-inline-block w--current"></a>
            </div>
            @break;
        @endif
    @endforeach
            ...
            @if(count($ads) > 0) 
              ...
              @endif
                  @if($va->position == 4 && $va->type==3)
                      ...
                      @endif
                      <div class="advertising" style=" background-image: url({{$ads_image}});">
                          <a href="{{ $ads_link }}" rel="noreferrer" target="_blank" class="link-block-promotion w-inline-block w--current"></a>
                      </div>
                      @break;
                  @endif
              @endforeach
        ...
        <div class="product">
          ...
          <div class="div-block-1176">
            ...
            <div class="div-block-69 w-clearfix"><a href="#" class="link-block-4 w-inline-block"></a>
              <a target="_blank" rel="noreferrer" href="https://www.google.com/maps/search/{{ urlencode($v->mSchooltranslations[0]->name.' '.$v->mSchooltranslations[0]->address) }}" class="link-7" style="font-size:13px">{{$v->mSchooltranslations[0]->address}}</a></div>
            <p class="paragraph-6">
