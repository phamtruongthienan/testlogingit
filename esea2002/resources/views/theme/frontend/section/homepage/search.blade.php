            ...
            <div class="div-block-1095 block-search-basic row">
                <div class="block-search-txt col-lg-9 col-md-12 col-sm-12 row">
                    <div class="col-md-6 col-sm-6">
                        <input placeholder="{{trans('front.homepage.search.keyword')}}" aria-label="keyword" id="keyword" name="keyword"
                               class="div-block-109 txt-search txt-search-keyword basic_search"/>
                    </div>
                    <div class="col-md-6 col-sm-6">
                        <input placeholder="{{trans('front.homepage.search.location')}}" aria-label="location" id="location" name="location"
                               class="div-block-109 txt-search txt-search-area basic_search"/>
                    </div>
                </div>
                <div class="div-block-1108-copy col-lg-3 col-md-12 col-sm-12 block-search-pc block-search-custom">
                    ...
                    <a href="#" data-toggle="tooltip" data-placement="top"
                       ...
                       class="button-7 w-button btn-search-advanced block-search-pc" data-current="fa-chevron-down"
                       data-next="fa-chevron-up">
                        <i class="fas fa-chevron-down"></i>
                    </a>
                </div>
            </div>
            <div class="div-block-1111">
                <div data-w-id="24fd5cfe-882c-1ab8-73c1-15877e791798" class="div-block-1112 mb-3 block-search-advanced">
                ...
                <div class="block-search-custom">
                    <div class="div-block-1108-copy block-search-sp">
                        <div class="div-block-109 search">
                            <button id="searchBtn2" class="w-inline-block" style="width: 100%;background-color: unset;">
                                <div class="text-block-48-copy">{{mb_strtoupper(trans('front.homepage.search.button'))}}</div>
                            </button>
                        </div>
                    </div>
                    <a href="#" data-toggle="tooltip" data-placement="top"
                       title="{{trans('front.homepage.search.advanced.text')}}"
                       data-w-id="8d743e4d-96e9-38f7-fe69-8a043e755fc4"
                       class="button-7 w-button btn-search-advanced block-search-sp" data-current="fa-chevron-down"
                       data-next="fa-chevron-up">
                        <i class="fas fa-chevron-down"></i>
                    </a>
                </div>
