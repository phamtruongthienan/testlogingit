        ...
        <div class="mask-2 w-slider-mask">
            @foreach($client as $k => $v)
                <div class="slide-11 w-slide">
                    <a href="{{ asset($v->mClienttranslations[0]->mSchool->mSchooltranslations[0]->slug) }}" rel="noreferrer" target="_blank">
                        <div class="div-block-46">
                            @php
                                $logo_client =  Imgfly::imgPublic($v->mClienttranslations[0]->logo.'?w=180&h=180&fit=crop-center');
                            @endphp
