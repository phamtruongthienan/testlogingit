...
@section('meta_title')
{{$config_main[0]->configMainTranslations[0]->meta_title}}
@endsection
@section('meta')
    <meta name="keywords" content="{{$config_main[0]->configMainTranslations[0]->meta_keyword}}">
    <meta name="description" content="{{$config_main[0]->configMainTranslations[0]->meta_description}}">
@endsection
@section('content')
            ...
            <div class="div-block-1095 block-search-basic row">
                ...
                <div class="div-block-1108-copy col-md-3 col-sm-12">
                    <div class="div-block-109 search">
                            <button id="searchBtn3" class="w-inline-block" style="width: 100%;background-color: unset;">
