...
@endsection
@section('meta_title')
{{$school_detail[0]->mSchooltranslations[0]->meta_title}}
@endsection
@section('meta')
    <meta name="keywords" content="{{$school_detail[0]->mSchooltranslations[0]->meta_keyword}}">
    <meta name="description" content="{{$school_detail[0]->mSchooltranslations[0]->meta_description}}">
@endsection
@section('content')
