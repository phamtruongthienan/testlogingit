...
app.init = function () {
	...
	$(document).on('click', '.table-dynamic-role .table-action-edit', function (e) {
		...
		$('#modal-role-edit #ttlModal').html('Cập nhật quyền');
		$('#modal-role-edit #inputEditNameDisplay').prop('required',false);
		$('#modal-role-edit #edit_description').prop('required',false);
        $('#editRoleForm').validator('validate');
		$('#modal-role-edit #inputEditNameDisplay').prop('required',true);
		$('#modal-role-edit #edit_description').prop('required',true);
        $('#editRoleForm').validator('update');
		var id = $(this).data('id');
		$.ajax({
	...
	$(document).on('click', '#addRole', function (e) {
        ...
        $('#modal-role-edit #ttlModal').html('Thêm quyền mới');
		$('#modal-role-edit').modal('show');	
	});
