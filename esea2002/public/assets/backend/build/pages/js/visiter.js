...
app.init = function () {
	...
	$(document).on('click', '.table-action-edit', function (e) {
        ...
        $('#editVisiterForm').validator('validate');
        ...
        $('#editVisiterForm').validator('update');
		$('#modal-visiter-edit #ttlModal').html(" Thêm khách tham quan");
	...
	$(document).on('click', '#addVisiter', function (e) {
		...
		$('#modal-visiter-edit #ttlModal').html(" Cập nhật khách tham quan");
