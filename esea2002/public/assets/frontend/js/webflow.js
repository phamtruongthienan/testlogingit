$(function() {
    ...
    $(document).on("click", ".menu-button", function(event) {
        ...
        if ($(".w-nav-overlay").is(":visible")) {
            ...
            $(this).next().height($(document).height() - $(".navbar").outerHeight());
...
function toggleElementSearch(element) {
    $(document).on("click", element, function(event) {
        ...
        var i = $(element).find('.fas');
        if(i.hasClass('fa-chevron-down')) {
            i.removeClass('fa-chevron-down').addClass(next);
        } else {
            i.removeClass('fa-chevron-up').addClass(next);
        }
        $(element).attr('data-current', next);
        $(element).attr('data-next', current);
        if ($('.block-search-advanced').is(":visible")) {
            $('.block-search-advanced').slideUp();
            $(this).removeClass('w--open');
            $('.block-search-advanced').removeClass('w--open');
        } else {
            $('.block-search-advanced').slideDown();
            $(this).addClass('w--open');
            $('.block-search-advanced').addClass('w--open');
        }
    });
}
