    ...
    Route::group(['prefix' => 'admin_esearch', 'middleware' => ['auth:admin']], function () {
       ...
       // Route::get('localization', 'Web\AdminController@admin_localization_index')->name('admin.localization')->middleware('permission:admin_localization_view');
        ...
        Route::group(['prefix' => 'ajax'], function () {
            ...
            Route::get('groupmail/{id}', 'Web\AdminController@admin_group_email_ajax')->name('admin.group.email.ajax');
            Route::get('mailgroup/{id}', 'Web\AdminController@admin_get_mail_group_ajax')->name('admin.get.mail.group.ajax');
            Route::post('email', 'Web\AdminController@admin_post_email_ajax')->name('admin.post.email.ajax');
            Route::get('export/{id}', 'Web\AdminController@admin_export_email_ajax')->name('admin.export.email.ajax');
            ...
            Route::get('group', 'Web\AdminController@admin_group_ajax')->name('admin.group.ajax');
            Route::post('group', 'Web\AdminController@admin_post_group_ajax')->name('admin.post.group.ajax');
            ...
            Route::get('statics/view', 'Web\AdminController@admin_statics_view_ajax')->name('admin.statics.view.ajax');
						Route::get('search', 'Web\AdminController@admin_search_ajax')->name('admin.search.ajax');
						Route::post('search', 'Web\AdminController@admin_post_search_ajax')->name('admin.post.search.ajax');
						Route::get('attribute', 'Web\AdminController@admin_attribute_ajax')->name('admin.attribute.ajax');
						Route::post('attribute', 'Web\AdminController@admin_post_attribute_ajax')->name('admin.post.attribute.ajax');
        });
    });
