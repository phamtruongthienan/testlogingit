...
class CreateSearchKeywordManagementTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::dropIfExists('m_keyword');
				Schema::dropIfExists('m_keyword_translation');
        ...
        Schema::create('m_keyword', function (Blueprint $table) {
			...
			Schema::create('m_keyword_translation', function (Blueprint $table) {
				$table->increments('id');
				$table->string('name');
			...
			Schema::table('m_keyword_translation', function (Blueprint $table) {
				$table->foreign('language_id')->references('id')->on('config_language');
				$table->foreign('translation_id')->references('id')->on('m_keyword');
			});
