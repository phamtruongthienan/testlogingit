...
/**
 * Class MSchoolCategoryTranslation
 *
 * @property int $id
 ...
 * @package App\Models
 */
class MSchoolCategoryTranslation extends Eloquent
{
    use Searchable;
    public $asYouType = true;

    use \Illuminate\Database\Eloquent\SoftDeletes;
    protected $table = 'm_school_category_translation';
    ...
    {
        return $this->belongsTo(\App\Models\MSchoolCategory::class, 'translation_id');
    }
}
