            ...
            <div class="nav-tabs-custom posr">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="listNews">
                        <a class="text-green cursor-pointer posa" data-lang="{{LaravelLocalization::getCurrentLocaleID()}}" id="addNews">
...
@section('script')
    <script src="{{asset('assets/backend/build/pages/js/news.js')}}"></script>
@endsection